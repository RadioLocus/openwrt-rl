...
int
radiolocus_init_interface(struct uci_map *map, void *section, struct uci_section *s)
{
...
radiolocus_allocate(struct uci_map *map, struct uci_sectionmap *sm, struct uci_section *s)
{
